---
title: "FSNMS Round 28 Data Recoding and Analysis"
...
# t %>% filter(interview.section_a.A04 == "Warrap") %>% ggplot(aes(x=month, y=percentage)) + geom_bar(stat="identity", fill = "#007DBC") + facet_wrap(~interview.section_a.A04) +
#   geom_text(aes(label = round(percentage*100, 1), vjust = -0.3)) + theme_minimal()
